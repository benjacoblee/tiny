...
AWS.config = new AWS.Config({
  accessKeyId: config.get("S3_KEY"), // stored in the .env file
  secretAccessKey: config.get("S3_SECRET"), // stored in the .env file
  region: config.get("BUCKET_REGION") // This refers to your bucket configuration.
});
